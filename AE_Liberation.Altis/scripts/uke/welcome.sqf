...
_att hintC [
    ...
    parseText "<t shadow='2'size='1' >Rule #1</t><br/><t shadow='2'size='0.75' >All Players MUST be on our Teamspeak Server to gain Permissions.</t>",
    ...
    parseText "<t shadow='2'size='1' >Rule #5</t><br/><t shadow='2'size='0.75' >Try not to just take snipers otherwise its a camp fest</t>",
    parseText "<t shadow='2'size='1' >Rule #6</t><br/><t shadow='2'size='0.75' >Dont 1 seat Attack Helos</t>",
    ...
    <br/>
    <br/>
    Avoid killing Civillians, Search all Buildings and Capture any surrendering AI for interregatiTry not to just take snipers otherwise its a camp fest
    <br/>
