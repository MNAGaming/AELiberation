class Params
{
	...
	class UKEOPTIONS {
		title = $STR_PARAMS_UKE_OPTIONS;
		values[] = {""};
		texts[] = {""};
		default = "";
	};
	class UKECarrierRovers {
		...
		texts[] = {$STR_PARAMS_DISABLED,"Black Wasp","Black Wasp Stealth","Sentinel","Wipeout","Greyhawk","Falcon","BlackFoot","Pawnee","Hellcat","Ghosthawk","FA-18 E","FA-18 F", "EA-18G","AV-8B","AH-1Z" };
		default = 11;
	};
